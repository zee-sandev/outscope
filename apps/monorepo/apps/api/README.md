# @outscope/orpc-hono Example

A production-ready example demonstrating the `@outscope/orpc-hono` package - an OOP-based decorator pattern for building type-safe APIs with [Hono](https://hono.dev) and [oRPC](https://orpc.io).
...
import { Controller, Implement, Implementer } from '@outscope/orpc-hono'
...
- [@outscope/orpc-hono Documentation](../../packages/orpc-hono/README.md)
